...
// --------------------------------------------------------------------------------
function captain_admin_settings() {
	...
	if (isset($_POST['submit'])) {
		...
		if (!$is_free_plan) {
			// Update the API secret of the plugin
			update_option('captain-api-secret', trim($_POST['captain-api-secret']));
					...
					<form id="captainup-settings-form" action="" method="post">
						<div class="postbox cpt-colors">
							<div class="inside">
								...
								<p>Copy your API key from the <a href='https://captainup.com/manage/settings' target='_blank'>Settings tab</a> in your Captain Up admin panel and paste it here. You need to <a href='https://captainup.com/users/sign_up' target='_blank'>Sign Up</a> if you don't have a Captain Up account.</p>
								...
								?>
									<p>
										Copy the API Secret from the <a href='https://captainup.com/manage/settings' target='_blank'>Settings tab</a> in your Captain Up admin panel and paste it here.
									</p>
									<div id='cpt-secret'>
